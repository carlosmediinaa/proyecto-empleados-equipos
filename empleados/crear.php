...
<html lang="es">
  <head>
    ...
    <title>Crear Empleado - Impulsora</title>
    <!-- Bootstrap CSS -->
      ...
      <section class="row mb-4">
        <div class="col-12">
          <div class="d-sm-flex justify-content-between align-items-center">
            <h1 class="h2 text-success d-block d-sm-inline">Crear Nuevo Empleado</h1>
              ...
              <form id="formularioEmpleado" method="POST" novalidate>
                ...
                <div class="mb-3">
                  ...
                  <select class="form-select" id="departamento" name="departamento" required>
                    ...
                    <option value="IT" <?php echo (isset($departamento) && $departamento === 'IT') ? 'selected' : ''; ?>>IT</option>
                    <option value="Recursos Humanos" <?php echo (isset($departamento) && $departamento === 'Recursos Humanos') ? 'selected' : ''; ?>>Recursos Humanos</option>
                    <option value="Ventas" <?php echo (isset($departamento) && $departamento === 'Ventas') ? 'selected' : ''; ?>>Ventas</option>
                    <option value="Marketing" <?php echo (isset($departamento) && $departamento === 'Marketing') ? 'selected' : ''; ?>>Marketing</option>
                    <option value="Finanzas" <?php echo (isset($departamento) && $departamento === 'Finanzas') ? 'selected' : ''; ?>>Finanzas</option>
                    <option value="Operaciones" <?php echo (isset($departamento) && $departamento === 'Operaciones') ? 'selected' : ''; ?>>Operaciones</option>
                    <option value="Otro" <?php echo (isset($departamento) && $departamento === 'Otro') ? 'selected' : ''; ?>>Otro</option>
                  </select>
                  <div class="invalid-feedback">
